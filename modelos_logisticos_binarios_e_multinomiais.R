...
# de se chegar atrasado quando o trajeto tem 7 km e passa-se por 10 semáforos 
# no percurso?
...
# pressão: pressão de verificação de vazamento (psi-libra-força por polegada ao 
# quadrado)
